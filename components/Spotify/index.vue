<template>
  ...
  >
    <div class="flex justify-between">
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" class="max-sm:w-6" height="30" width="29.0625" viewBox="0 0 496 512">
          <path
            fill="currentColor"
    ...
    <div class="flex gap-4 items-center">
      ...
      <div class="flex grow flex-col gap-2">
        ...
        <span :class="{ 'p-3 bg-white/20 animate-pulse rounded-lg w-32': spotify.isLoading }" class="sm:text-lg"
        ...
        <span :class="{ 'p-3 bg-white/20 animate-pulse rounded-lg w-44': spotify.isLoading }" class="sm:text-lg"
